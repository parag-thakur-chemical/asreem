        ...
        <div className="mt-12 bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-3">
                Bank Details for Indian Participants (INR):
              </h3>
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-gray-700">
                  <span className="font-medium">Account Name:</span> Director,
                  SVNIT-CCE
                </p>
              </div>
            </div>
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-3">
                Bank Details for International Participants (USD):
              </h3>
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700">
                  <span className="font-medium">Account Number:</span>{" "}
                ...
                <p className="text-gray-700">
                  <span className="font-medium">Branch:</span> SVNIT Campus,
                  Surat
                </p>
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-500">
              After making the payment, please email the transaction details to{" "}
              <a
