    ...
    <div className="py-12 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <div className="prose max-w-none">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Registration Fees (inclusive of 18% GST):</h3>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {registrationFees.map((item, index) => (
                      <tr key={index}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-right">{item.fee}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="bg-amber-50 p-4 rounded-md border-l-4 border-amber-400 mb-6">
                <p className="text-amber-800 text-sm">
                  The course fee includes 18% GST as per institute norms. Single-bedded shared accommodation can be availed upon prior request (at additional cost).
                </p>
              </div>

              <p className="text-gray-700 mb-6">
                Participants can pay the registration fees via NEFT/IMPS/UPI using the following account details or QR code.
              </p>

              <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Bank Account Details:</h3>
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <p className="mb-2"><span className="font-medium">Account Number:</span> 37030749143</p>
                    <p className="mb-2"><span className="font-medium">IFSC Code:</span> SBIN0003320</p>
                    <p><span className="font-medium">Account Name:</span> Director, SVNIT-CCE</p>
                  </div>
              ...
              <div className="mt-10 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Click the button below to complete your registration through our Google Form.
                </p>
                <a
                ...
                <p className="mt-4 text-sm text-gray-500">
                  After making the payment, please complete the registration through the Google Form and email the transaction details to{' '}
                  <a href="mailto:asreem2026@ched.svnit.ac.in" className="text-green-600 hover:underline">asreem2026@ched.svnit.ac.in</a>
                </p>
              </div>
            </div>
          </div>
            ...
            <ul className="space-y-4">
              {importantDates.map((item, index) => (
                <li key={index} className="flex justify-between items-center pb-3 border-b border-gray-100 last:border-0 last:pb-0">
                  ...
                  <span className="font-medium text-gray-900 bg-green-50 px-3 py-1 rounded-full text-sm">{item.date}</span>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="mt-12 bg-white p-8 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Contact for Registration</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-2">Department of Chemical Engineering,</h3>
              <p className="text-gray-700">Sardar Vallabhbhai National Institute of Technology,</p>
              <p className="text-gray-700">Surat - 395 007, Gujarat, India</p>
            </div>
            <div>
              <p className="text-gray-700">
                <span className="font-medium">Email:</span> asreem2026@ched.svnit.ac.in
              </p>
              <p className="text-gray-700">
