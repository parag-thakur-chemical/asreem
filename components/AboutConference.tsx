...
export function AboutConference() {
  return (
    <section className="py-10 md:py-14 bg-gray-100 text-gray-800 md:px-20">
      <div className="container mx-auto px-4">
        ...
        <div className="md:hidden space-y-6 px-2">
          ...
          <p className="text-justify">
            This conference invites people from different walks of life, who
            share a common vision towards the implementation of sustainable
            processes for the management of environmental hazards. It will
            provide a platform for discussion on issues that are prevalent in
        ...
        <div className="hidden md:flex flex-col md:flex-row gap-8 lg:gap-12">
          ...
          <div className="md:w-1/2 space-y-6">
            ...
            <p className="text-justify">
              ...
              Engineering Department, SVNIT, Surat, Gujarat. The organisers are
              working in the field of the 'Energy and Environmental Management'
              sector for the past decade. They share a common thought process
              for the development of 'solution-oriented research'.
            </p>
