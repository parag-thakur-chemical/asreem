...
export default function Hero() {
  return (
    ...
    >
      ...
      <div
        className="
        relative container mx-auto px-2 sm:px-4 z-10
      ...
      >
        <div className="max-w-5xl w-full mx-auto space-y-6">
          ...
          {/* Date */}
          <div className="inline-block bg-offWhite bg-opacity-10 backdrop-blur-sm px-2 sm:px-4 py-1 sm:py-2 rounded-md mb-2">
          ...
          {/* Main Heading */}
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight break-words font-[Montserrat]">
